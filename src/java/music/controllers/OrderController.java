...
public class OrderController extends HttpServlet {
    ...
    private String addItem(HttpServletRequest request,
        ...
        int avail = ProductDB.getAvailable(id);
        if (product != null) {
            if (avail > 0)
            {
            ...
            {
                String message = "Sorry, this item is currently out of stock.";
    ...
    private String completeOrder(HttpServletRequest request,
        ...
        // update product Available column
        ProductDB.updateAvailabe(invoice);
        ...
        for (LineItem item : lineItems)
        {
            ...
            Double itemPrice = p.getPrice() * itemQuantity;
            NumberFormat currency = NumberFormat.getCurrencyInstance();
            String itemTotal = currency.format(itemPrice);
        ...
        String body = "<p>Dear " + user.getFirstName() + ",<br><br>" +
            "Thanks for ordering from us. " +
            "In 3-5 business days you should receive the following: <br><br>" + 
            "<table>" +
                "<tr>" +
                    "<th>Qty</th>" +
                    "<th>Description</th>" +
    ...
    private boolean checkQuantity(String productCode)
    {
